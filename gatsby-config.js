module.exports = {
  ...
  siteMetadata: {
    author: 'Project Multinacional Laboratory',
    description: 'a multinational research project for science',
    siteUrl: 'https://multinacional-lab.netlify.app/',
    title: 'Multinacional Laboratory',
